...
test('Test to create a lead', async ({page}) => {
    page.setDefaultTimeout(120000) //Overrides the default timeout of 30s
    await page.goto("http://leaftaps.com/opentaps/control/main");
    //Enter username
    await page.getByLabel("Username").fill("demosalesmanager", {timeout:40000});
    ...
    //Click Login
    await page.locator("text=CRM/SFA").click({timeout:40000});
